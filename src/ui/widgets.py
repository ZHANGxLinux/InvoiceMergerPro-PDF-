...
class GlassCard(QFrame, GlowShadowMixin):
...
class GradientLabel(QLabel):
    def __init__(self, text="", parent=None):
        ...
        self.setObjectName("gradientTitle")
...
class InteractiveButton(QPushButton, GlowShadowMixin):
    ...
    def enterEvent(self, event):
        ...
        self._run_scale(1.0, 1.03 if self.objectName() == "primaryButton" else 1.02)
        super().enterEvent(event)
    ...
    def mouseReleaseEvent(self, event):
        target = 1.03 if self.objectName() == "primaryButton" and self.underMouse() else 1.0
        if self.objectName() == "primaryButton" and self.underMouse():
            target = 1.03
...
class TitleBarButton(QPushButton):
    def __init__(self, text, role="normal", parent=None):
        super().__init__(text, parent)
        self.setObjectName(f"titleBtn_{role}")
...
class CustomTitleBar(QWidget):
    def __init__(self, window, parent=None):
        ...
        self.logo = AppLogoWidget(26)
        self.title = QLabel("发票合并助手")
        self.title.setObjectName("titleBarName")
        ...
        self.file_btn.setObjectName("menuTextBtn")
        self.help_btn = QPushButton("帮助")
        self.help_btn.setObjectName("menuTextBtn")
        layout.addWidget(self.file_btn)
        layout.addWidget(self.help_btn)
        layout.addStretch()

        self.min_btn = TitleBarButton("—", "min")
        self.max_btn = TitleBarButton("□", "max")
...
class EmptyFilePlaceholder(QWidget):
    def __init__(self, parent=None):
        super().__init__(parent)
...
class FileListPanel(QListWidget):
    def __init__(self, parent=None):
        ...
        self.setSpacing(2)
        self._placeholder = EmptyFilePlaceholder(self)
...
class ValueSlider(QWidget):
    ...
    def __init__(self, label, minimum=1, maximum=8, value=1, parent=None):
        ...
        self.slider.setObjectName("gradientSlider")
...
class PreviewPanel(QWidget):
    ...
    def _layout_empty(self):
        ...
        self.image_label.setProperty("hasPaper", False)
    ...
    def _apply_scale(self):
        ...
        self.image_label.setProperty("hasPaper", True)
        self.image_label.style().unpolish(self.image_label)
        self.image_label.style().polish(self.image_label)
    ...
    def set_has_content(self, has_content):
